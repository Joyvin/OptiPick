...
async def scrape():
    ...
    if url:
        newUrl = url.replace("product-reviews", "dp", 1)
        print(f"URL MAIN IS {newUrl}")
        form_data = {
            "url": newUrl,
        ...
        print("")
        respon = requests.post("http://localhost:3000/api/details", data=form_data)
        details = respon.json()
        ...
        if len(review2) != 0:
            ...
            myData = {
                ...
                "datas": [myData1["opinion"], myData2["opinion"]],
        ...
        doc_ref = (
            ...
            .document(userID)
            .collection("history")
            .document(f"history{randomValue}")
        )
