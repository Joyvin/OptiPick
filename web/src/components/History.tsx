      ...
      data: [
		{
		  ...
		  aspects: [
			...
			{ value: "best", sentiment: "positive", score: 1.0, target: "Colgate" },
			{ value: "Good", sentiment: "positive", score: 1.0, target: "product" },
			{ value: "Best", sentiment: "positive", score: 1.0, target: "quality" },
                ...
                >
                  ...
                  <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                    <div>
                      ...
                      <div className="text-xs font-light">{splitString[1]}</div>
                    </div>
                  </div>
                </a>
              </li>
